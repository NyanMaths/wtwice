...
if Path("upscalers/wthrice/checkpoints/train_dataset.pkl").exists() and Path("upscalers/wthrice/checkpoints/test_dataset.pkl").exists():
    train_dataset, test_dataset = torch.load("upscalers/wthrice/checkpoints/train_dataset.pkl"), torch.load("upscalers/wthrice/checkpoints/test_dataset.pkl")
else:
    train_dataset, test_dataset = random_split(full_dataset, (0.9, 0.1))
    torch.save(train_dataset, "upscalers/wthrice/checkpoints/train_dataset.pkl")
    torch.save(test_dataset, "upscalers/wthrice/checkpoints/test_dataset.pkl")
